...
def generate_git_log_follow_mocks():
    ...
    recorder = CommandMockRecorder("git", fixtures_root=Path(__file__).parent)
...
def main():
    ...
    try:
        ...
        print("\n✓ All framework example mocks generated successfully!")
        print("\nMock files created:")
        ...
        print("\nFor domain-specific mocks, consuming projects should:")
        print("  1. Import command_mock library")
        print("  2. Create their own mocks/ directory with test data")
        print("  3. Point fixtures_root to their local mocks directory")
